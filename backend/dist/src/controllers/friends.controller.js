...
const sentFriendRequestEmail = async (username, email) => {
...
const acceptedFriendRequestEmail = async (username, email) => {
    const command = new InvokeCommand({
...
export const sendFriendRequest = async (req, res) => {
    try {
        ...
        try {
            await sentFriendRequestEmail(user.username, potentialFriend.email);
        }
        catch (lambdaErr) {
